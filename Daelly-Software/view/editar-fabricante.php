...
$fabricante = $control->selecionar(addslashes($_GET['id']));
?>
    ...
    <body>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">            
            ...
            <div id="conteudo">               
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Fabricantes</h1>
                    </div>
                </div>
                            ...
                            <form action="" method="POST" id="form">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="campo_esquerda">
                                        <input type="text" class="form-control" value="<?php echo (isset($_POST['nome'])) ? $_POST['nome'] : $fabricante->nome ?>" name="nome" id="nome" placeholder="Informe o nome" required="required" data-toggle="tooltip" title="Informe o nome" data-placement="auto"/>
                                    </div>
                                </div>		
                            </form>
                        </div>
        ...
        <script>
            $(document).ready(function () {
                ...
                $(".voltar").click(function (){
                   $(location).attr("href", "fabricantes.php");
                });
