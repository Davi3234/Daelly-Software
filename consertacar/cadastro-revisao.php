                        ...
                        <form action="" method="POST" id="form" name="form">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="campo_esquerda">
                                    <input type="date" class="form-control" value="<?php echo (isset($_POST['data_manutencao'])) ? $_POST['data_manutencao'] : "" ?>" name="data_manutencao" id="data_manutencao" placeholder="Informe a data da manutenção" required="required" data-toggle="tooltip" title="Informe a data da manutenção" data-placement="auto" />
                                </div>
