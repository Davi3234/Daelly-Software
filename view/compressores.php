                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions-form table">
                                                    <a href="editar-compressor.php?id=<?php echo $c->id ?>" class="editar bt-action table bt-edit tooltip-content"><span class="material-symbols-outlined">edit_square</span><span class="tooltip">Editar Compressor</span></a>
                                                    <a href="#" rel="<?php echo $c->id ?>" class="excluir bt-action table bt-remove tooltip-content"><span class="material-symbols-outlined">delete</span><span class="tooltip">Excluir Compressor</span></a>
                                                    <a href="manutencoes-por-compressor.php?id=<?php echo $c->id ?>" class="bt-action table bt-list tooltip-content"><span class="material-symbols-outlined">build</span><span class="tooltip">Manutenções deste compressor</span></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php } ?>
