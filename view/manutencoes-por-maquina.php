...
$maquina = $controlMC->selecionar(addslashes($_GET["id"]));
$manutencoes = $control->listarByMaquina($maquina->id);
?>
        ...
        <div id="painel-comando">
            ...
            <div class="conteudo">
                <div class="conteudo-header">
                    <h2>Manutenções da máquina <?php echo $maquina->codigo ?></h2>
                </div>
                ...
                <div class="conteudo-main">
                    <form action="" method="POST" id="form">
                        ...
                        <div class="actions-form">
                            <a href="cadastro-manutencao.php?maquina-costura=<?php echo $maquina->id ?>" type="submit" class="bt-action form primary icon-content rigth">Novo<span class="material-symbols-outlined">library_add</span></a>
