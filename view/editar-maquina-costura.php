...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($control->editar($_POST['codigo'], $_POST['modelo'], $_POST['marca'], $_POST['chassi'], $_POST['aquisicao'], $_POST['id_tipo'], addslashes($_GET['id']))) {
        $mensagem = "Máquina editada com sucesso";
        unset($_POST);
    } else {
        $erros = "";
...
$maquinaCostura = $control->selecionar(addslashes($_GET['id']));
                        ...
                        <form action="" method="POST" id="form">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="campo_esquerda">
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['codigo'])) ? $_POST['codigo'] : $maquinaCostura->codigo ?>" name="codigo" id="codigo" placeholder="Informe o código" required="required" data-toggle="tooltip" title="Informe o código" data-placement="auto" />
                                </div>
                                <div class="campo_direita">
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['modelo'])) ? $_POST['modelo'] : $maquinaCostura->modelo ?>" name="modelo" id="modelo" placeholder="Informe o modelo" required="required" data-toggle="tooltip" title="Informe o modelo" data-placement="auto" />
                                </div>
                                <div class="campo_esquerda">
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['marca'])) ? $_POST['marca'] : $maquinaCostura->marca ?>" name="marca" id="marca" placeholder="Informe a marca" required="required" data-toggle="tooltip" title="Informe a marca" data-placement="auto" />
                                </div>
                                <div class="campo_direita">
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['chassi'])) ? $_POST['chassi'] : $maquinaCostura->chassi ?>" name="chassi" id="chassi" placeholder="Informe o chassi" required="required" data-toggle="tooltip" title="Informe o chassi" data-placement="auto" />
                                </div>
                                <div class="campo_esquerda">
                                    <input type="text" class="form-control" value="<?php echo (isset($_POST['aquisicao'])) ? $_POST['aquisicao'] : $maquinaCostura->aquisicao ?>" name="aquisicao" id="aquisicao" placeholder="Informe a data de aquisição" required="required" data-toggle="tooltip" title="Informe a aquisição" data-placement="auto" />
                                </div>
                                <div class="campo_direita">
                                    <select class="form-control" id="id_veiculo" name="id_veiculo">
                                        ...
                                        ?>
                                            <?php if ($maquinaCostura->id_tipo == $t->id) {
                                            ?>
