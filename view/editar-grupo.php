                        ...
                        <form action="" method="POST" id="form" name="form">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="campo_esquerda">
                                    <input type="text" class="form-control" value="<?php echo $grupo->numero ?>" name="numero" id="numero" placeholder="Informe o n�mero" required="required" data-toggle="tooltip" title="Informe o n�mero" data-placement="auto" />
                                </div>
                            </div>
                    </div>
                </div>
