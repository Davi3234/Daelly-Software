                    ...
                    <ul class="user-menu">
                        <li class="dropdown pull-right">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg><span class="nome_usuario">Usu�rio Logado </span><span class="caret"></span>                                    
                            </a>
                            ...
                            <div class="panel-body">
                                <form action="" method="POST" id="form">
                                    ...
                                    <table data-toggle="table" data-show-refresh="true" data-id-field="1" data-show-toggle="true" data-show-columns="false" data-search="true" data-select-item-name="selecionados[]" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                                        ...
                                        <tbody> 
                                            <?php if ($maquina) foreach ($maquina as $m) { ?>
                                                    <tr>
                                                        <td><?php echo $m->id ?></td>                                                        
                                                        <td><?php echo $m->codigo ?></td>    
                                                        <td><?php echo $m->marca ?></td>   
                                                        <td><?php echo $m->modelo ?></td>  
                                                        <td><?php echo $m->chassi ?></td>   
                                                        <td><?php echo $m->aquisicao ?></td>    
                                                        <td><?php echo $m->tipo ?></td>                                                   
                                                        <td>
                                                            <a href="#" class="editar" rel="<?php echo $m->id ?>">Editar</a>&nbsp;&nbsp;&nbsp;
                                                            <a href="#" class="excluir" rel="<?php echo $m->id ?>">Excluir</a>
                                                        </td>                                                        
                                                    </tr>
                                                <?php } ?>
                                        </tbody>
